...
A lightweight, punchy web application that fetches random Chuck Norris facts and jokes using the ChuckNorris.io API.
...
Because Chuck Norris doesn't call an API; the API offers him data out of fear.
